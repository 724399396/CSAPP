...
int bitCount(int x) {
  ...
  int tmp_mask4 = (0xFF) | (0x00 << 8);
  int mask4 = (tmp_mask4) | (tmp_mask4 << 16);
  int mask5 = (0xFF) | (0xFF << 8);
  int y = (x & mask1) + ((x >> 1) & mask1);
  y = (y & mask2) + ((y >> 2) & mask2);
  y = (y & mask3) + ((y >> 4) & mask3);
  y = (y & mask4) + ((y >> 8) & mask4);
  y = (y & mask5) + ((y >> 16) & mask5);
  return y;
}
/* 
